 ...
 * @since AM 5.5.0
 */
public class FailureMessageAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(FailureMessageAuthNodePlugin.currentVersion,
				Collections.singletonList(com.example.FailureMessageAuthNode.FailureMessageAuthNode.class));
	}
	...
	public String getPluginVersion() {
		return FailureMessageAuthNodePlugin.currentVersion;
	}
}
